...
Rendered 2026-09-18 07:40 UTC by `python tests/evals.py --suite sample` from `docs/evals.json` · 20 questions.
...
| `full` | 100-row subset | **12 / 12** (8 not run) | 1,491 | `openai/gpt-oss-120b` | 2026-09-18 06:46 UTC |
| `naive` | 100-row subset | not run (20 skipped) | — | `openai/gpt-oss-120b` | 2026-09-18 06:46 UTC |
